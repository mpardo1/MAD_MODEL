...
#include "math.h"
// ¡¡¡¡OJO¡¡¡¡ si no es MAC poner #include "malloc.h", cambiar en todos los archivos
#include "malloc.h"
#include "stdlib.h"
#include "stdio.h"
...
double rk78( double *at, double x[], double *ah, double tol,
              double hmin, double hmax, int n, int numparam_rk, double *param_rk, double *y_rk, double **arr_spline_rk,  int dim_mos_rk,
              void ( *deriv ) ( int , double, double *, int , double *, double *, double **, int , double *))
{
         ...
         for ( i = 0; i < 13; i++ )
           ...
           m=m+1;
            ...
            for(k=0; k<10;k++){
                 ...
                 */
            ( *deriv )( n, tpon, xpon, numparam_rk, param_rk, y_rk, arr_spline_rk, dim_mos_rk ,dx_rk);
            // Check if pointers works:
            /*
