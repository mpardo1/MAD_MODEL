...
trueSD = 1
# Easy plots:
output <- load("~/Documentos/PHD/2021/SUR_Model/OUTPUT/chain2_IC_0_03_MH_2000eq_3param_15000_2021-09-23.RData")
# Ubuntu:
...
### Summary: #######################
 ...
 correlationPlot(data.frame(chain_mc))
  ...
  # Ubuntu:
  output <- load("~/Documentos/PHD/2021/SUR_Model/OUTPUT/chain3_MH_2000eq_3param_15000_2021-09-22.RData")
  chain_mcmc2 <- mcmc(chain)
  plot(chain_mcmc2)
  correlationPlot(data.frame(chain_mcmc2))
  ...
  # output2 <- load("~/Documents/PHD/2021/SUR_Model/OUTPUT/chain2_MH_op_100eq_3param10000.RData")
  # Ubuntu:
  output <- load("~/Documentos/PHD/2021/SUR_Model/OUTPUT/chain_MH_2000eq_3param_15000_2021-09-22.RData")
  chain_mcmc2 <- mcmc(chain)
  plot(chain_mcmc2)
  correlationPlot(data.frame(chain_mcmc2))
  combinedchains = mcmc.list(chain_mc, chain_mcmc2)
