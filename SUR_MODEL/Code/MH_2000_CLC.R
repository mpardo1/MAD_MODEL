...
# 
filename <- paste0("~/MAD_MODEL/SUR_MODEL/Code/chain3_IC_0_03_var_0_0008_MH_2000eq_3param_",iterations,"_",Sys.Date(),".RData") #Salva cada ronda de optimizaciones, por si acaso
