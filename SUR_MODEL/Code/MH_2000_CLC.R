...
proposalfunction = function(param){
  vec <- param + c(rnorm(3, mean = c(0,0,0), sd= c(0.008,0.00008,0.00008))
...
# 
filename <- paste0("~/MAD_MODEL/SUR_MODEL/Code/chain_0.008_MH_2000eq_3param_",iterations,"_",Sys.Date(),".RData") #Salva cada ronda de optimizaciones, por si acaso
