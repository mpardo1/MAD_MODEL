...
# In Path_users write the path where the file users.csv is saved
Path_users = "/home/marta/Documentos/PHD/2021/SUR_Model/Code/RStudio/Fitting/data/users.csv" 
download = read.csv(Path_users) 
...
write.csv(downloads_uni,"/home/marta/Documentos/SUR Model/Code/RStudio/Fitting/downloads.csv")
...
Path = "/home/marta/Documentos/PHD/2021/SUR_Model/Code/RStudio/Fitting/"
setwd(Path)
...
#-------------------------------------------------FITTING-----------------------------------------------------------------
# Fake data to perform fitting.
Data <- matrix (nc=2,byrow=2,data=c(2, 0.14,
                                    4, 0.21,
                                    6, 0.31))
colnames(Data) <- c("time", "P1")
